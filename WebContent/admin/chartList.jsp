...
<head>
    ...
    <script src="chartmain.js"></script>
    ...
    $(function(){  
            $('#execute_chart').on("click", function(){
            ...
            /* $('#modify_chart').on("click", function(){
    ...
    function deleteChart(chart_id) {
        ...
        if(ret == true)
            location.href='chartDelete.io?chart_id=' + chart_id;
    }
    
    function modifyChart(chart_id) {
        //location.href='chartModify.io?chart_id=' + chart_id;
              //console.log("test");
            $.ajax({
              type : "GET",
              url : "chartModify.io",
...
<div class="wrapper">
    ...
    <div class="main-panel">
        ...
        <div class="content" id="test">
            ...
            <!-- DataTables 컬럼 선언 -->
                <h1>차트게시판 관리</h1>
                <table id="chartdata" class="table table-striped table-bordered display">
                    <thead>
                        <tr>
                            <th></th>
                            <th>차트아이디</th>
                 ...
                 <input class="btn btn-primary" type="button" id="execute_chart" value="차트 속성 작성"/> 
            </div>
        </div>
